  ...
  return (
    <div className="bg-white shadow-lg rounded-xl overflow-hidden p-5 border">
      ...
      <div className="flex items-center gap-4">
        <img src={job.company_logo} alt={job.company} className="w-12 h-12 rounded-full" />
        <div>
      ...
      {/* Job Type & Deadline */}
      <p className="text-sm text-gray-600">Job Type: <span className="font-medium">{job.jobType}</span></p>
      <p className="text-sm text-gray-600">Deadline: <span className="font-medium">{job.applicationDeadline}</span></p>

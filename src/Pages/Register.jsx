...
const Register = () => {
  const { createUser, updateUserProfile,  logOutUser, loading} = useContext(AuthContext);
  ...
  const handleRegister = (e) => {
    ...
    createUser(email, password)
      ...
      .catch(error => {
        console.error(error);
        setError({ ...error, message: "Registration Failed! Please Provide your valid email and password" });
      });
  };
        ...
        <form onSubmit={handleRegister}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              type="text"
              className="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded focus:outline-none focus:border-blue-500"
              placeholder="Paste your photo URL" required
            />
          </div>
          <div className="mb-4">
